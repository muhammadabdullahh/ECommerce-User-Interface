...
public class Product
{
	...
	public void print()
	{
		System.out.printf("\nId: %-5s Category: %-9s Product Name: %-20s Price: %7.1f", id, category, name, price);
	}

	public void printStat(){
		//System.out.println("Id: "+ id + "\tProduct Name: " + name + "\t\t# Of Orders: " + stat);
		System.out.printf("\nId: %-5s Product Name: %-20s # Of Orders: %-10d", id, name, stat);
	}
